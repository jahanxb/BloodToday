...
$Recipient_RecipientID=$_GET['var1'];
...
$Recipient_RecipientID=strip_tags($_POST['Recipient_RecipientID']);
...
try {
if($userRow1 = $person->recipientComplaint($contactedBy,$contactedTo,$Recipient_RecipientID,$person_PersonID,$complaintINFO)) {

            if(sendMail($contactedTo,$complaintINFO)){
                echo "<script> alert('complaint Registered successfully Against Recipient'); </script>";
            }
      ...
      <div class="row breadcrumbs margin-bottom-40">
          <div class="container">
              <div class="col-md-4 col-sm-4">
                  <h1>Complaint Recipient Form</h1>
              </div>
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 login-signup-page">
            <form method="post" name="form1">
              ...
              <input type='hidden' name='Recipient_RecipientID' value="<?php echo $_GET['var1']; ?>"></input>
         ...
         <option value="R:SECTION:10:User Not Responding">User Not Responding to Call</option>
         <option value="R:SECTION:11:User is fraud">User is fraud</option>
         <option value="R:SECTION:12:User Misbehavior">User Misbehaved</option>
         <option value="R:SECTION:13:Other">Other</option>
...
!-->
  ...
  function sendMail($contactedTo,$complaintINFO){
    ...
    $mail->addAddress($contactedTo, "Complaint Against Recipient");

    $mail->isHTML(true);

    $mail->Subject = "Complaint Against User (Recipient Profile)";
