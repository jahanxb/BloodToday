...
if(isset($_POST['contact-btn-invite'])){
  $contactedBy=strip_tags($_POST['contactedBy']);
  $contactedTo_1=strip_tags($_POST['contactedTo']);
  $RecipientFlag=strip_tags($_POST['RecipientFlag']);
  $DateTime=strip_tags($_POST['date'].' '.$_POST['time']);
//  $Date=strip_tags($_POST['date']);
//  $Time=strip_tags($_POST['time']);
  if($person->history_recp($contactedBy,$contactedTo_1,$RecipientFlag,$DateTime)) {
      //	$person->redirect('history.php');
        sendMail($contactedTo_1,$contactedBy,$DateTime);
      ...
      <div class="row breadcrumbs margin-bottom-40">
          <div class="container">
              <div class="col-md-4 col-sm-4">
                  <h1>Send Invite To Recipient</h1>
              </div>
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 login-signup-page">
            <form method="post" name="form1">
              ...
              <input type='hidden' name='RecipientFlag' value='1'></input>
              ...
              <div class="input-group margin-bottom-20">
                ...
                <span class="label label-default">Invite From</span>
...
<span class="label label-default">To:</span>
  ...
  ?>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                        <input type="submit" class="btn btn-signup" value="Send Request" name="contact-btn-invite"/>
                                      </div>
                                  </div>
...
!-->
  ...
  <!-- END PAGE CONTAINER -->
  <?php
  function sendMail($email, $contactedBy,$DateTime){
  	$mail = new PHPMailer;
  	...
  	$mail->Subject = "Hi, I will Like to Donate Blood";
  	$mail->Body = "Respected Person, <br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; This Person :'.$contactedBy.
    ' Contacted  you for Blood Donation , The Person is willing to Donate Blood at datetime'
    .$DateTime.'  , This auto-generated email is sent to your email: <b>"."<a>bloodtodayorg@gmail.com</a>"."</b>. <hr>
  	Thanks for using our services."." if this isn't your email:.
     "."<a>bloodtodayorg@gmail.com</a>"."Let us Know <br> Thanks for using our services.";
